...
- (void)viewDidLoad {
    ...
    copyBtn.tintColor = [UIColor colorWithRed:0.0 green:0.71 blue:0.68 alpha:1.0];
    ...
    shareBtn.tintColor = [UIColor colorWithRed:0.0 green:0.71 blue:0.68 alpha:1.0];
    ...
    _bannerLabel.textColor = [UIColor colorWithWhite:0.25 alpha:1.0];
    _bannerLabel.backgroundColor = [UIColor colorWithWhite:0.96 alpha:1.0];
    ...
    separator.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.10];
...
- (void)copyAllLog {
    ...
    toast.backgroundColor = [UIColor colorWithRed:0.0 green:0.71 blue:0.68 alpha:0.9];
