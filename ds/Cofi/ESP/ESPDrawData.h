...
typedef struct {
    ...
    uint64_t pawn; // Stable per-enemy identity — drives the 3-colour name rotation
                   // and tracks box stabilisation across frames. Forwarded from
                   // ESPPlayerData.pawn by the frame builder.
